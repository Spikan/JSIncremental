...
(global as any).window = {
  DOM_CACHE: {
    sodaButton: {
      parentNode: {
        getBoundingClientRect: vi.fn(() => ({ left: 100, top: 200, width: 150, height: 150 })),
      },
    },
    shopDiv: {
      getBoundingClientRect: vi.fn(() => ({ left: 300, top: 100, width: 200, height: 150 })),
    },
    levelUpDiv: {
    ...
    beforeEach(() => {
      ...
      (global as any).Decimal =
        ...
        class Decimal {
          ...
          plus(other: any) {
            return new Decimal(this._value + Number(other));
          }
          minus(other: any) {
            return new Decimal(this._value - Number(other));
          }
          ...
          gte(other: any) {
            return this._value >= Number(other);
          }
          lte(other: any) {
            return this._value <= Number(other);
          }
