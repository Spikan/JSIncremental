  ...
  describe('Save System', () => {
    ...
    it('should handle save data validation', () => {
      ...
      const requiredFields = [
        'sips', 'straws', 'cups', 'suctions', 'fasterDrinks',
        'widerStraws', 'betterCups', 'criticalClickChance',
        'criticalClickMultiplier', 'criticalClicks', 'criticalClickUpCounter',
        'suctionClickBonus', 'level', 'totalSipsEarned', 'totalClicks',
        'gameStartDate', 'lastClickTime', 'clickTimes', 'lastSaveTime'
      ];
