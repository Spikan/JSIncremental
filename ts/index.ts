...
try {
  ...
  // Inline drink system to avoid import hanging issues in production
  console.log('🔧 Creating inline drink system...');
  
  // Inline drink system implementation
  const processDrinkFactory = ({
    getNow = () => Date.now(),
  ...
  console.log('✅ Inline drink system created');
