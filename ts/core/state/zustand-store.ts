...
import type { GameState, GameOptions } from './shape'
    ...
    persist(
      subscribeWithSelector((set) => ({
        ...
        actions: {
          ...
          addCriticalClicks: (amount) => set((state) => ({ criticalClicks: state.criticalClicks + amount })),
          ...
          addTotalSipsEarned: (amount) => set((state) => ({ totalSipsEarned: state.totalSipsEarned + amount })),
          ...
          setBestClickStreak: (streak) => set((state) => ({ 
